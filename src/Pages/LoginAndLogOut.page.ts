...
export class LoginAndLogout {
  ...
  //     await page.waitForTimeout(3000);
  //       await this.verifyElementIsVisibleinhttp(page, 'Project Name', jsondata.proceedbutton);
  //       console.log("At proceedbutton");
  //       await page.click(jsondata.proceedbutton);
  //       console.log("After Clicked on proceedbutton success.");
  //       await page.waitForTimeout(3000); 
  //       await this.verifyElementIsVisibleinhttp(page, 'Project Name', jsondata.projectSelector);
  //       console.log("project is visible login is success");
  //       await page.waitForTimeout(3000);
  // }
...
public async httpMasterChecks(page: Page) { 
   ...
   // const proceedbutton = jsondata.proceedbutton
    ...
    try {
        ...
        // await this.verifyElementIsVisibleinhttp(page, 'Project Name', proceedbutton);
        // console.log("proceedbutton");
        // await page.click(proceedbutton);
        // console.log("Clicked on confirmbutton success.");
  
       // Check if project element exists and click
       

       
        // await this.verifyElementIsVisibleinhttp(page, 'Project Name', projectSelector);
        // console.log("project is visible login is success");
        // await page.click(projectSelector);
        // console.log("Clicked on Project Name element.");
...
//******************************************************//downloadAgent CASE//******************************************************
  ...
  //-----------------------USER IS ABLE TO ADD AND DELETE TEXT CASE
