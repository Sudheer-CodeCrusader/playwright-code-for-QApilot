...
import * as CloudData from "../../CloudiOSData.json";
// import axios from 'axios';
export class CloudiOS {
  readonly page: any;
  constructor() {
    // this.page = "";
  ...
  public async Testcase_Recording_Functionality(page : any){
    ...
    if (RetryButton) {
      // If the Retry Button is found, click it
      console.log('Retry button found, clicking it...');
      await RetryButton.click();
    } else {
      // If the Retry Button is not found, skip the action
      console.log('Retry button not found, skipping action.');
    }
